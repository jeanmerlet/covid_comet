...
meta_out_path = '/lustre/orion/syb111/proj-shared/Projects/sars-cov-2_geo/data/metadata/metadata_2022_06_02/usa-counties/usa-counties_dates_locations.tsv'
epi_out_path = '/lustre/orion/syb111/proj-shared/Projects/sars-cov-2_geo/data/metadata/metadata_2022_06_02/usa-counties/usa-counties_epi-ids.txt'
...
for i, seq_id in enumerate(meta.index.values):
    ...
    if (
        ...
        if len(meta.loc[seq_id, 'Collection date']) == 10:
            row_idx[i] = True
