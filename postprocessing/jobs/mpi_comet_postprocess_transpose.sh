...
export COMET_OUT_FILES_DIR="/gpfs/alpine/syb105/proj-shared/Projects/GeoBio_CoMet/data/aligned/sequences_2021_09_30/uniq_ids/preprocessed_d-cutoff_1000_n-cutoff_0.01_pos_342-29665/transposed/ns-as-1s_mutation_count_filtered_100/combined_all_output"
...
for BATCH in $(seq 1 $NUM_BATCHES) ; do
    ...
    sbatch \
        ...
        -t 1:00:00 \
        -J comet_post \
        -o ./logs/comet_post_double.%J.out \
        -e ./logs/comet_post_double.%J.err \
        ./comet_srun.sh
done
